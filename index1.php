...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Laboratorio Clinico</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> Estamos aqui para ayudarte!</h4>
          </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Inicio de sesion</h3><br>
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  <div class="col-md-4"><label>Correo: </label></div>
                  <div class="col-md-8"><input type="text" name="email" class="form-control" placeholder="Correo Electronico" required/></div><br><br>
                  <div class="col-md-4" style="margin-top: 8%"><label>Contraseña: </label></div>
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password2" placeholder="Contraseña" required/></div><br><br><br>
                </div>
                <div class="row">
