...
if (isset($_POST['docsub'])) {
  ...
  $query = "insert into doctor(usuario,password,correo,especialidad,honorarios)values('$doctor','$dpassword','$demail','$spec','$docFees')";
  $result = mysqli_query($con, $query);
  if ($result) {
    echo "<script>alert('Técnico creado correctamente');</script>";
  }
}
...
if (isset($_POST['docsub1'])) {
  $demail = $_POST['demail'];
  $query = "delete from doctor where correo='$demail';";
  $result = mysqli_query($con, $query);
  if ($result) {
    echo "<script>alert('Técnico eliminado correctamente');</script>";
  } else {
...
<body style="padding-top:50px;">
  <div class="container-fluid" style="margin-top:50px;">
    <h3 style="margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> BIENVENIDO </h3>
    <div class="row">
      <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list" role="tab"
            data-toggle="list" aria-controls="home">Añadir Técnicos</a>
          <a class="list-group-item list-group-item-action" href="#list-settings1" id="list-ddoc-list" role="tab"
            data-toggle="list" aria-controls="home">Eliminar Técnicos</a>
        </div><br>
      </div>
        ...
        <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Técnicos</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i
                          class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Pacientes</h4>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Administrar Técnicos</h4>

                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-adoc-list')">Agregar Técnicos</a>
                        &nbsp|
              ...
              <div class="row">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $con = mysqli_connect("localhost", "root", "", "myhmsdb2");
                    global $con;
                    $query = "select d.usuario doctor, r.id pid,c.id ID, p.pnombre fname, p.papellido lname, r.fecha appdate, r.hora apptime, '' disease, '' allergy, r.comentario prescription from resultado r inner join cita c on c.id = r.id_cita inner join doctor d on d .id = c.id_doctor inner join paciente p on p.id = c.id_paciente";
                    $result = mysqli_query($con, $query);
                    while ($row = mysqli_fetch_array($result)) {
                      $doctor = $row['doctor'];
                      $pid = $row['pid'];
          ...
          <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-pat-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                $query = "select c.id ID, p.id pid, p.pnombre fname, p.papellido lname, p.genero gender, p.correo email, p.telefono contact, d.usuario doctor, d.honorarios docFees, c.fecha appdate, c.hora apptime, c.userStatus, c.doctorStatus from cita c
          ...
          <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              <div class="row">
                <div class="col-md-4"><label>Usuario del Técnico:</label></div>
                <div class="col-md-8"><input type="text" class="form-control" name="doctor"
                    onkeydown="return alphaOnly(event);" required></div><br><br>
                <div class="col-md-4"><label>Especialidad:</label></div>
                <div class="col-md-8">
                  <select name="special" class="form-control" id="special" required="required">
                    <option value="head" name="spec" disabled selected>Selecciona especialidad</option>
                    <option value="General" name="spec">General</option>
                    <option value="Cardiologia" name="spec">Cardiologia</option>
                    <option value="Neurologia" name="spec">Neurologia</option>
                    <option value="Pediatria" name="spec">Pediatria</option>
                  </select>
                </div><br><br>
                ...
                <div class="col-md-4"><label>Confirmar Contraseña:</label></div>
                ...
                <div class="col-md-4"><label>Honorarios:</label></div>
                <div class="col-md-8"><input type="text" class="form-control" name="docFees" required></div><br><br>
              </div>
              <input type="submit" name="docsub" value="Añadir Técnico" class="btn btn-primary">
            </form>
          </div>
          ...
          <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              ...
              <input type="submit" name="docsub1" value="Eliminar Técnico" class="btn btn-primary"
                onclick="confirm('¿Esta seguro de eliminar al técnico?')">
            </form>
          </div>
